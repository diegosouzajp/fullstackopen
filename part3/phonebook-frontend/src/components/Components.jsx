...
const showMessage = (props, message, color) => {
    ...
    if (person) {
          ...
          personService
            ...
            .then(() =>
              personService.getAll().then((response) => {
                ...
                showMessage(props, `Added ${props.newName}`, "green");
              })
            )
            .catch(() =>
              showMessage(
      ...
      personService
        ...
        .then((newPerson) => {
          ...
          props.setNewName("");
          props.setNewNumber("");
          showMessage(props, `Added ${newPerson.name}`, "green");
        })
        .catch((error) => {
          showMessage(props, error.response.data.error, "red");
